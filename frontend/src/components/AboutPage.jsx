    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-teal-50 to-purple-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="bubble-text text-4xl font-bold mb-4">
              <GradientText>{t.about.stats.title || "Ted by the Numbers"}</GradientText>
            </h2>
            <p className="soft-text text-xl text-gray-600">{t.about.subtitle}</p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="bubble-text text-4xl font-bold mb-4">
              <GradientText>{t.about.specialties.title}</GradientText>
            </h2>
            <p className="soft-text text-xl text-gray-600">{t.about.specialties.subtitle}</p>
          </div>
